...
def calcularMediaNotas(notasAluno):
    return 0 if len(notasAluno) == 0 else sum(notasAluno) / len(notasAluno)
...
# Fluxo: Read data -> Encontra o aluno pelo Matrícula -> Atualiza o aluno no dicionário obtino no Read
